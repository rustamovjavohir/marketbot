...
admin_id = [779890968]  # Сюда вставляем всех админов через запятую [123123, 837148, 12312] или только одного [123]
verification = False  # True - если хотите поставить проверку на человека
token = "5447202255:AAG6Qu5Pb8ve76aAp0sCsQHIGassQWTMnJA"  # токен бота
